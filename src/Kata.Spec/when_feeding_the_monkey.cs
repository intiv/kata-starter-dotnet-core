...
namespace Kata.Spec
{
    ...
    public class when_user_input_contains_new_line_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_one_negative
    {
        ...
        Because of = () => { _result = Catch.Exception(() => _systemUnderTest.Add("-1")); };
        It should_throw_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -1"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }

    public class when_user_input_is_multiple_negatives
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_numbers_larger_than_1000
    {
        ...
        It should_do_return_sum_of_lower_than_1001 = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_is_multiple_numbers_with_multiple_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
