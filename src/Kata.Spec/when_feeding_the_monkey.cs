...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_multiple_numbers_with_single_char_delimeter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_has_negative_number
    {
        ...
        It should_throw_exception = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_has_multiple_negatives
    {
        ...
        Because of = () => { _result = Catch.Exception(() => _systemUnderTest.Add("-1,-2,-3")); };
        It should_throw_exception = () => { _result.Message.Should().Be("negatives not allowed: -1, -2, -3"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }
